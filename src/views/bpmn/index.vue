<template>
  <div id="app">
    ...
    <wfd-vue ref="wfd" :data="demoData" :height="700" :users="candidateUsers" :groups="candidateGroups" :categorys="categorys" :lang="lang" />
...
<script>
import WfdVue from './activiti/components/Wfd'
export default {
  name: 'app',
  components:{
    WfdVue
